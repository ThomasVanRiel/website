...
export class Chip8 {
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        Chip8Finalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
    ...
    static new(rom) {
        ...
        const ret = wasm.chip8_new(ptr0, len0);
    ...
    step(keys) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.chip8_step(this.__wbg_ptr, ptr0, len0);
    }
    tick_timers() {
        wasm.chip8_tick_timers(this.__wbg_ptr);
    }
}
