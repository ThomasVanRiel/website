            ...
            <For each={tags}>
              {(tag) => (
                <li class="bg-brand-lt dark:bg-brand-dk">
                  <button onClick={() => toggleTag(tag)} class={cn("w-full px-2 py-1 rounded ", "whitespace-nowrap overflow-hidden overflow-ellipsis", "flex gap-2 items-center", "bg-brand-dk/5 dark:bg-brand-lt/10", "hover:bg-brand-dk/10 hover:dark:bg-brand-lt/15", "transition-colors duration-300 ease-in-out", filter().has(tag) && "text-black dark:text-white")}>
