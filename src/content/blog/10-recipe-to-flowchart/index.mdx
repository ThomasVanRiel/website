...
Fill in your recipe in the text box and click <kbd>Generate Flowchart</kbd>. Two example recipes are added below to showcase the recipe syntax and a possible final image after (re)organizing the flowchart. Feel free to copy them in the recipe text box to see what happens.
...
*The flowchart adapts to light/dark mode, but looks better in light mode in my opinion.* 
