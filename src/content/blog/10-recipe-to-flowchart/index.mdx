...
Fill in your recipe in the text box and click <kbd>Generate Flowchart</kbd>. Two example recipes are added below to showcase the recipe syntax. Feel free to copy them in the recipe text box to see what happens.
