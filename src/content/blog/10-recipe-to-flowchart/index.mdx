...
*The generated images are not optimized for dark mode as the exporter (currently) only supports light mode exporting for printing purposes. The background is transparent by design, which might look strange in some image viewers.*
