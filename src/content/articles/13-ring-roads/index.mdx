...
Where $R$ is the radius of the best fitting circle, $C(x)$ and $C(y)$ are the coordinates of the circle center.

$$
RMS = \sqrt{\frac{\sum_{i}^{n}{d_i^2}}{n}}
$$
