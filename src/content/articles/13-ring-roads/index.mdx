...
The vector lines representing roads are rasterized using **Bresenham's line algorithm** to a 800x800 pixel image, 
with pixel size chosen such that the entire road fits within the image.  
Next, the rasterized image is **dilated** using a 5x5 square structuring element to ensure that the road is continuous, 
