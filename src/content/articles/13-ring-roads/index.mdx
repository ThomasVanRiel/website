...
RANSAC counts the points that are **not** part of the tested circle and tries to minimize this count in further iterations.
MSAC is better https://doi.org/10.1109/ICCV.1998.710798
MLESAC is better https://doi.org/10.1006/cviu.1999.0832

<Figure
    src="/ring-roads/cost_function.png"
    alt="Caption WIP"
/>

<Figure
    src="/ring-roads/RANSAC.mp4"
    alt="Animation of the MSAC fitting process"
/>
