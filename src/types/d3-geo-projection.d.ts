declare module 'd3-geo-projection' {
  ...
  export function geoChamberlin(point0: [number, number], point1: [number, number], point2: [number, number]): GeoProjection;
  ...
  export function geoGilbert(projection?: () => GeoProjection): GeoProjection;
  ...
  export function geoModifiedStereographic(coefficients: any, rotate: [number, number, number]): GeoProjection;
  ...
  export function geoTwoPointAzimuthal(point0: [number, number], point1: [number, number]): GeoProjection;
  export function geoTwoPointEquidistant(point0: [number, number], point1: [number, number]): GeoProjection;
